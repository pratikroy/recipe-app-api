...
class PrivateRecipeApiTests(TestCase):
    ...
    def test_recipes_limited_to_user(self):
        """Test that api returned for authenticated user"""
    ...
    def test_full_update_recipe(self):
        """Test updating a recipe with put update"""
        recipe = sample_recipe(user=self.user)
        recipe.tags.add(sample_tag(user=self.user))
        payload = {
                'title': 'New recipe',
...
class RecipeImageUploadTests(TestCase):
    """Test uploading image to recipe model"""
    ...
    def test_filter_recipes_by_tags(self):
        ...
        recipe3 = sample_recipe(user=self.user, title='Recipe title three')
    ...
    def test_filter_recipes_by_ingredients(self):
        ...
        recipe1 = sample_recipe(user=self.user, title='Some title one')
        recipe2 = sample_recipe(user=self.user, title='Some title two')
